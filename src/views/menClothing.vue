<template>
  <v-app>
    ...
    <v-row class="pt-5">
          <v-col
            class="mb-5"
            v-for="menclothing in menclothings" :key='menclothing.id'
            cols="4"
          >
    <v-card  max-width="270">
      <v-img contain height="250" :src="menclothing.image">
      </v-img>
...
export default {
  ...
  mounted(){
    Vue.axios.get("https://fakestoreapi.com/products/category/men's clothing")
    .then((response) => {
      this.menclothings =response.data,
